...
<div class="sidebar show" id="sidebar">
    ...
    <div class="tool">
        ...
        <a href="#" class="statut"><i class="fa fa-power-off"></i></a>
    </div>
    <div class="sidebar-container">
        <div class="sidebar-item"><span class="title-item"><i class="fa fa-home fa-2x"></i>Accueil</span></div>
        <div class="sidebar-item drop">
            <span class="title-item"><i class="fa fa-map-marker fa-2x"></i>Intervention</span>
            <div class="submenu">
                <a href="/test" class="submenu-item"><span class="title-item"><i class="fa fa-list fa-2x"></i>Liste</span></a>
                <a href="#" class="submenu-item"><span class="title-item"><i class="fa fa-plus-circle fa-2x"></i>Ajouter</span></a>
            </div>
        </div>
        <a href="#" class="sidebar-item"><span class="title-item"><i class="fa fa-user fa-2x"></i>Pompier</span></a>
        <div class="sidebar-item"><span class="title-item"><i class="fa fa-car fa-2x"></i>Véhicules</span></div>
